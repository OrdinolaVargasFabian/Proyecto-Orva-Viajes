<div class="mb-3">
    ...
    <div class="d-flex justify-content-between">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mdlAgregarCliente"><i class='bx bx-plus me-2'></i>Registrar</button>
...
<div class="card-datatable table-responsive bg-light p-3 rounded shadow">
    <table id="datatable-cliente" class="table table-striped" style="width: 100%;">
        <thead>
            <tr>
