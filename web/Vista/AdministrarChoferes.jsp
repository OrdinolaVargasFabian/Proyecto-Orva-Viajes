                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-inline-block text-nowrap">
                                <a href="../ControladorChofer?accion=editar&idChofer=${choferes.getId()}" type='button' class='btn btn-icon btn-outline-success  me-2'><i class='bx bxs-edit'></i></a>
                                <a href="javascript:eliminarChofer(${choferes.getId()})" type='button' class='btn btn-icon btn-outline-danger  me-2'><i class='tf-icons bx bxs-trash'></i></a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
